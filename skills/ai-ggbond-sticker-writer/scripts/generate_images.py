...
load_env_file()
DEFAULT_MODEL = os.environ.get("YUNWU_DEFAULT_MODEL", "gpt-image-2")
...
def main():
    ...
    parser.add_argument('-m', '--model', default=os.environ.get('YUNWU_DEFAULT_MODEL', 'gpt-image-2'), help='模型名称')
