...
AI_SUPER_ENV_PATH = Path(r"f:\AI Workstation\AI\Super_OPC\.trae\skills\ai-super-individual-wechat-writer\.env")


def load_env_file():
    script_dir = Path(__file__).parent
    env_files = [script_dir.parent / ".env", AI_SUPER_ENV_PATH]
...
load_env_file()
DEFAULT_MODEL = os.environ.get("YUNWU_DEFAULT_MODEL", "gemini-3.1-flash-image-preview")
...
def main():
    ...
    parser.add_argument('-m', '--model', default=os.environ.get('YUNWU_DEFAULT_MODEL', 'gemini-3.1-flash-image-preview'), help='模型名称')
