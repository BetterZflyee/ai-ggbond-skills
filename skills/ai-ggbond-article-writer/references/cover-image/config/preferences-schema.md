...
description: EXTEND.md YAML schema for ai-ggbond-article-writer user preferences
---
...
preferred_palette: null   # warm|elegant|cool|dark|earth|vivid|pastel|mono|retro|duotone or null for auto-select

preferred_rendering: null # flat-vector|hand-drawn|painterly|digital|pixel|chalk|screen-print or null for auto-select
...
| `duotone` | High-contrast two-color palette — cinematic, poster-like |
...
| `screen-print` | Bold color blocks, halftone textures, poster art look |
