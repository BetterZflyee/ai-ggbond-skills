...
description: First-time setup flow for aiggbond-post-to-wechat preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.ai-ggbond-skills/aiggbond-post-to-wechat/EXTEND.md` | Current project |
| User | `~/.ai-ggbond-skills/aiggbond-post-to-wechat/EXTEND.md` | All projects |
