...
def cmd_create(args):
    ...
    if args.wait:
        default_download_dir = "F:\\AI Workstation\\AI\\Super_OPC\\SuperIp\\Videos"
        return cmd_wait_logic(task_id, args.interval or 15, args.download or default_download_dir)
