...
class Video(Media):
    ...
    def get_out_dir(self) -> Path:
        ...
        default_video_dir = Path("f:/AI Workstation/AI/Super_OPC/SuperIp/Videos")
        default_video_dir.mkdir(parents=True, exist_ok=True)
        return get_dir(candidates, default=default_video_dir)
...
class Music(Video):
    ...
    def get_out_dir(self) -> Path:
        ...
        default_music_dir = Path("f:/AI Workstation/AI/Super_OPC/SuperIp/Music")
        default_music_dir.mkdir(parents=True, exist_ok=True)
        return get_dir(candidates, default=default_music_dir)
...
class Downloader:
    ...
    def extract_info(self) -> dict[str, Any]:
        ...
        if info is None:
            raise ValueError(f"Failed to extract info from {self.url}")
        id = info.get("id")
        if self.verbose:
