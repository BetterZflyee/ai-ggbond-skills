---
name: agent-reach
description: Give your AI Agent internet capabilities (search, read, watch) with one command.
github_url: https://github.com/Panniantong/Agent-Reach
github_hash: 08421fa0e4cb8ca781e3bbce073b2e8d9bdb6c92
version: 0.1.0
created_at: 2026-02-26
entry_point: scripts/wrapper.py
dependencies: ["agent-reach"]
---

# Agent Reach

Give your AI Agent internet capabilities (search, read, watch) with one command.

## Usage

This skill wraps the `agent-reach` CLI tool.

### Commands

- `install`: Install dependencies and configure environment.
- `doctor`: Check the status of configured channels.
- `configure`: Configure specific channels (e.g., twitter cookies, proxy).

Example usage:
```bash
python scripts/wrapper.py install --env=auto
python scripts/wrapper.py doctor
```
